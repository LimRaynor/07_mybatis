...
public class PrintResult {
    ...
    public void printMenuList(List<com.ohgiraffers.section02.javaconfig.MenuDTO> menuList) {
        System.out.println("===== 메뉴 목록 ======");
        for(com.ohgiraffers.section02.javaconfig.MenuDTO menuDTO : menuList) {
            System.out.println(menuDTO);
        }
    }

    public void printMenu(com.ohgiraffers.section02.javaconfig.MenuDTO menu) {
